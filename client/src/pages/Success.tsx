...
import { Heart, Sparkles, ImageIcon, Lock } from "lucide-react";
      ...
      >
        <div className="bg-white/60 backdrop-blur-xl rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-pink-200 border border-white/50 relative">
          ...
          >
             {/* Happy jumping cat */}
            <img 
              src="/uploads/happy-jumping-cat.jpg"
          ...
          >
            <h2 className="text-2xl md:text-3xl font-body text-foreground/80 font-semibold">
              YOU WERENT FORCED FOR THIS RIGHT?
            </h2>
            <p className="text-xl text-muted-foreground font-light max-w-lg mx-auto leading-relaxed">
              Ab toh aapke lode lag chuke hai bhai , aap escape krna is as difficult as it was for pablo escobar to save his life
            </p>
          </motion.div>
          ...
          >
            <div className="flex flex-col md:flex-row gap-4 w-full max-w-2xl justify-center">
              ...
              <Button
                onClick={() => setLocation("/secret-message")}
                className="px-8 py-6 text-xl rounded-full bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 shadow-lg shadow-rose-500/30"
              >
